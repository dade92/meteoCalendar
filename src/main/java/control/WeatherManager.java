...
public class WeatherManager {
	...
	/**
	 * aggiorna le weather information
	 * dell'evento
	 * @param e l'evento
	 */
	...
	/**
	 * recupera le weather forecast
	 * richiedendo alla weather station
	 * @param location luogo
	 * @param date data iniziale
	 * @param endDate data finale
	 * @return le weather forecast
	 */
	...
	/**
	 * crea nel database la
	 * weather information
	 * @param weather stringa del meteo
	 * @param date data
	 * @param temp temperatura
	 * @param e l'evento correlato
	 */
	...
	/**
	 * recupera (dal database) le weather forecast
	 * per il dato evento
	 * @param e l'evento 
	 * @return le weather forecast dell'evento
	 */
	...
	/**
	 * recupera le weather forecast
	 * dato l'evento e la data iniziale
	 * @param e l'evento
	 * @param date data iniziale
	 * @return le weather forecast
	 */
