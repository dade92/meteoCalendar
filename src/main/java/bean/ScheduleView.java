...
public class ScheduleView implements Serializable {
	...
	/**
	 * metodo invocato quando la pagina
	 * è caricata. chiama il Rescheduler
	 */
	public void checkForNotifications() {
		//solo se è la prima volta che viene chiamato dopo il login
		if(firstTime) {
	...
	/**
	 * metodo invocato quando la pagina è caricata 
	...
	/**
	 * invocato quando un evento viene selezionato
	 * @param selectEvent l'evento selezionato dall'utente
	 */
	public void onEventSelect(SelectEvent selectEvent) {
		...
		//controlla se è il creatore o meno
		if (calendarEvent.getOrganizerUser().getId() == um.getLoggedUser()
				.getId())
			notCreator = "false";
		else
			notCreator = "true";
		//controlla il tipo di evento cosi da reindirizzare l'utente sulla pagina giusta
	...
	/**
	 * recupera gli utenti notificati dall'utente
	 * @return gli utenti notificati
	 */
	...
	/**
	 * recupera gli utenti invitati all'evento
	 * @return
	 */
	...
	/**
	 * metodo invocato per cambiare la visibilità dell'utente
	 * @param selectEvent
	 */
